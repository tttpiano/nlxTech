...
Route::get('/shipping', function () {
    ...
    return view('front.policy.shipping_policy', ['pageTitle' => $pageTitle]);
})->name('shipping.policy');
Route::get('/security', function () {
    $pageTitle = "Chính Sách Bảo Mật Thông Tin";
    return view('front.policy.security_policy', ['pageTitle' => $pageTitle]);
})->name('security.policy');
Route::get('/sale', function () {
    $pageTitle = "Chính Sách Bán Hàng";
    return view('front.policy.sale_policy', ['pageTitle' => $pageTitle]);
})->name('sale.policy');
Route::get('/guarantee', function () {
    $pageTitle = "Chính Sách Bảo Hành";
    return view('front.policy.guarantee_policy', ['pageTitle' => $pageTitle]);
})->name('guarantee.policy');
Route::get('/change', function () {
    $pageTitle = "Chính Sách Đổi Trả";
    return view('front.policy.change_policy', ['pageTitle' => $pageTitle]);
})->name('change.policy');
...
Route::post('/filter_sp', [ShopController::class, 'filterProduct1'])->name('filter.shop');
...
Route::get('/products/keywords', [HomeController::class, 'search'])->name('products.search');
Route::get('/products/keywords1', [HomeController::class, 'searchLq'])->name('searchlq');
...
/// ----------------------------------- ADMIN NLXTech ------------------------------------------
///---------------------------------------------------------------------------------------------------------------------------------
Route::prefix('adminnangluongxanhtech')->group(function () {
...
Route::middleware('admin.login')->group(function () {
    Route::get('/adminnangluongxanhtech', [WebsiteController::class, 'showVisitsChart'])->name('admin.visits');
