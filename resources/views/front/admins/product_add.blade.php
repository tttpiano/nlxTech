                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('image_pro.store') }}">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <img src="{{ asset('images/'.Session::get('images')) }}" alt="user-avatar" class="d-block rounded img_edit" height="100" width="100" id="fileUpload" />
                                @else
                        ...
                        <form id="formAccountSettings" method="POST" onsubmit="return false">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input class="form-control" type="text" id="url_seo" name="url_seo" placeholder="url_seo" autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
